...
namespace PMS.web.Providers
{
    public class UserProvider : IUserProvider
    {
        ...
        {
            return _userManager.Users.Where(c => c.Id != CurrentUser.Id && c.JobStatus == "AE" && c.EmailConfirmed == true  && c is User).OrderBy(o => o.FullName).ToList();
            //&& c.ResponsibilityCode != "40000"
        }
        public List<User> GetRelatedUsers(int designationId, string CurrRespCode)
        {
            if (CurrRespCode.Substring(0, 2) == "43")
            {
                return _userManager.Users.Where(x => x is User && x.JobStatus == "AE" && x.JobCatId == 1 && x.ResponsibilityCode.Substring(0, 1) == "4").OrderBy(o => o.ResponsibilityCode).ToList();
            }

            else if (designationId==6 && CurrRespCode.Substring(2, 1) == "0")
            {
                return _userManager.Users.Where(x => x is User && x.JobStatus == "AE" && x.JobCatId == 1 && (
                                               // your section
            ...
            else 
            {
                ...
                {
                    // Director Cases
                    4 => _userManager.Users.Where(x => x is User && x.JobStatus == "AE" && x.JobCatId == 1 && (
                    ...
                    5 => _userManager.Users.Where(x => x is User && x.JobStatus == "AE" && x.JobCatId == 1 && (
                                              //Your Departments
                    ...
                    // maneger cases
                    6 => _userManager.Users.Where(x => x is User && x.JobStatus == "AE" && x.JobCatId == 1 && (
                                               // your section
                                               (x.ResponsibilityCode.Trim().Substring(0, 4) == CurrRespCode.Trim().Substring(0, 4)) ||
                                                // sections without department
                                                (x.ResponsibilityCode.Substring(3, 1) == "0" && x.ResponsibilityCode.Substring(4, 1) != "0") ||
                    ...
                    8 => _userManager.Users.Where(x => x is User && x.JobStatus == "AE" && x.JobCatId == 1 && (
                                               // your department
                                               (x.ResponsibilityCode.Substring(0, 3) == CurrRespCode.Substring(0, 3)) ||
                                                // all sections
                                                (x.ResponsibilityCode.Substring(4, 1) != "0") ||
                    ...
                    _ => _userManager.Users.Where(x => x is User && x.JobStatus == "AE" && x.JobCatId == 1 && x.ResponsibilityCode.Substring(0, 1) == "4").OrderBy(o => o.ResponsibilityCode).ToList(),
                };
            }
        }
        ...
        {
            return _userManager.Users.Where(x => x is User && x.FileNumber == FileNumber).FirstOrDefault();
        }
        ...
        public List<User> GetLowLevelUsers(int designationId, string CurrRespCode)
        {
            if (CurrRespCode.Substring(0, 2) == "43")
            {
                return _userManager.Users.Where(x => x is User && x.JobStatus == "AE" && x.JobCatId == 1 &&
            ...
            else
            {
                switch (designationId)
                {
                    ...
                    case 8:// Head of section cases
                        return _userManager.Users.Where(x => x is User && x.JobStatus == "AE" && (
        ...
        public List<User> GetAllLeaders(User CurrentUser)
        {
            return _userManager.Users.Where(x => x is User && x.JobStatus == "AE" && x.JobCatId == 1 && x.Id != CurrentUser.Id).ToList();
        }
        public User GetUserByResponsibilityCode(string ResponsibilityCode, int designationId)
        {
            return _userManager.Users.Where(x => x is User && x.ResponsibilityCode == ResponsibilityCode && x.DesignationId == designationId).FirstOrDefault();
        }

        List<string> IUserProvider.GetUserRolesAsync(User user)
        {
            throw new NotImplementedException();
        }

        User IUserProvider.GetCurrentUserAsync()
        {
            throw new NotImplementedException();
        }

        public User GetUserByResponsibilityCode(string ResponsibilityCode)
        {
            throw new NotImplementedException();
        }
    }
