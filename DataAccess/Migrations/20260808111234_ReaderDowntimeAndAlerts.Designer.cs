...
namespace DataAccess.Migrations
{
    ...
    [Migration("20260808111234_ReaderDowntimeAndAlerts")]
    partial class ReaderDowntimeAndAlerts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Core.Entities.MovementLog", b =>
                {
                    ...
                    b.ToTable("MovementLogs", t =>
                        {
                            t.HasCheckConstraint("CK_MovementLog_EmployeeOrPermit", "[EmployeeId] IS NOT NULL OR [PermitId] IS NOT NULL");
                        });
                });
